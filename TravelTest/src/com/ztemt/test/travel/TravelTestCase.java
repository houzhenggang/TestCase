...
public class TravelTestCase extends UiAutomatorTestCase implements UiWatcher {
    ...
    protected void setUp() throws Exception {
        ...
        getUiDevice().registerWatcher("travel", this);
    ...
    protected void tearDown() throws Exception {
        super.tearDown();
        getUiDevice().removeWatcher("travel");
    }
}
